...
var filename = "Snap.Net.exe";   // The name of the executable to launch - change this to match the file you want to launch at the end of your setup
...
try
{
    ...
    // make sure it only shows during install and not uninstall...
