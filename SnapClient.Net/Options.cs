...
namespace SnapClient.Net
{
    class Options
    {
        ...
        [Option("offset-tolerance", Default = 50, HelpText = "The tolerance for offset in milliseconds. This determines how quickly we'll enforce 'hard' syncs (cause audible pops).")]
